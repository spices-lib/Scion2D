...
namespace SCION_EDITOR {
	...
	template<CommandType ...Cmds>
	inline void AbstractCommandManager<Cmds...>::RunUndo(VarCommands<Cmds...>& undoableVariant)
	{
		std::visit([&](auto&& val) { RunUndo_Impl(val); }, undoableVariant);
	}

	template<CommandType ...Cmds>
	inline void AbstractCommandManager<Cmds...>::RunRedo(VarCommands<Cmds...>& redoableVariant)
	{
		std::visit([&](auto&& val) { RunRedo_Impl(val); }, redoableVariant);
	}
