...
namespace SCION_WINDOWING::Inputs
{
	...
	public:
		 ...
		 *
		 * @param axis Axis identifier (0¨C5 typical for standard controllers).
		 ...
		 *
		 * @param lowFrequencyRumble Strength of low-frequency motor (0¨C65535).
		 * @param highFrequencyRumble Strength of high-frequency motor (0¨C65535).
